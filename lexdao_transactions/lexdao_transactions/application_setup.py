...
def application_setup():
    """Create a Flask application and initialize the lexdao_transactions database"""

    username = os.environ.get("PG_USERNAME", "cimply")
    password = os.environ.get("PG_PASSWORD", "test")
    database_name = os.environ.get("DATABASE_NAME", "lexdao_transactions")
